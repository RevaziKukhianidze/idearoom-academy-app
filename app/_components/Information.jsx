  ...
  return (
    <section className="bg-white mt-8 sm:mt-12 md:mt-16 lg:mt-[64px] py-8 sm:py-12 md:py-16 lg:py-[64px] mb-12 sm:mb-16 md:mb-24">
      ...
      <Dialog open={isVideoOpen} onOpenChange={setIsVideoOpen}>
        <DialogContent className="text-secondary-500 max-h-[90vh] overflow-hidden max-lg:mt-[-30px] mt-[-10px] max-sm:mt-[-20px]  max-w-[500px] outline-none border-none bg-transparent shadow-none rounded-[30px] mx-auto max-md:mr-2 [&>button]:hidden">
          <DialogHeader className="max-sm:items-start">
            ...
            <div className="relative flex justify-center items-center w-full">
              <Image
                ...
                className="absolute max-2xl:right-[15%] top-[2%] right-[12.5%]  
                 cursor-pointer w-[36px] h-[36px] max-md:w-[28px]  max-md:h-[28px] z-50"
                src={cancel}
                alt="cancel-svg"
              />
              <video
                ...
                autoPlay={true}
                playsInline
                className="w-full object-contain max-w-[340px] border-none 2xl:max-w-[360px] outline-none rounded-[20px] relative aspect-[9/16]  fullscreen:h-screen fullscreen:max-w-none fullscreen:w-auto fullscreen:object-contain fullscreen:bg-black"
                onError={(e) => {
