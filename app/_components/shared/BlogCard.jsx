...
export default function BlogCard({ blog, blogIndex }) {
  return (
    <div
      key={blogIndex}
      className="bg-white blog-shadow py-4 max-lg:h-[530px] max-xl:h-[515px] h-[545px] max-md:h-[500px] max-sm:h-auto px-4 relative cursor-pointer rounded-[20px]"
    >
      <img
      ...
      <div className="py-4 sm:py-6">
        ...
        <div className="flex max-md:mt-[50px] max-sm:mt-[30px] lg:absolute max-lg:mt-[50px] bottom-[20px] right-[20px] justify-end">
