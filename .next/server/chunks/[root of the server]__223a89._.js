...
"[project]/app/api/offer/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$supabase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/services/supabase.js [app-route] (ecmascript)");
;
;
async function GET(request) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$supabase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].from("offered_course").select("*").eq("id", id).single();
        if (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__223a89._.js.map